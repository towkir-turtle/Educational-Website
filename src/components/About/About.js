...
const About = () => {
  return (
    <div className="about">
      <Container>
        <h2>Welcome to edureka's curriculum.</h2>
        <h5>Please slow down and read this.</h5>
        <p>edureka is a proven path to your first software developer job.</p>

        <p>
          More than 40,000 people have gotten developer jobs after completing
          this – including at big companies like Google and Microsoft.
        </p>
        ...
        <p>
          ...
          important than the certifications is the practice you get along the
          way.
        </p>
        ...
        <p>
          ...
          also have thousands of hours of video courses on edureka's YouTube
          channel.
        </p>
        ...
        <p>
          You can do this on Twitter and GitHub, and also on the edureka forum.
        </p>
